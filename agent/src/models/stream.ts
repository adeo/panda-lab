...
export interface ControlMsg {
    ...
    type: ControlType,
    text: string,
    metaState: number // KeyEvent.META_*
    action: number; // KeyEvent.ACTION_* or MotionEvent.ACTION_* or POWER_MODE_*
    keycode: number; // KeyEvent.KEYCODE_*
    buttons: number; // MotionEvent.BUTTON_*
    pointerId: number;
    pressure: number;
    position: Position;
    hScroll: number;
